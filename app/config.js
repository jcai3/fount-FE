...
.constant('ENV', {
  ...
  apiEnvname: 'local', //local  st?,  prod 
  
  apiEndpoint: 'http://localhost:9001/',
  instagramRedirectDomain: 'http://localhost:9001/',
  instagramClientId: '7d5af766cffa46c3b045dd5133001533',
  
  /*
  apiEndpoint: 'https://affiliatest.searshc.com/affiliate/',
  instagramRedirectDomain: 'https://affiliatest.searshc.com/affiliate/',
