...
.service('apiRepository', ['$rootScope', '$http', 'ENV', function($rootScope, $http, ENV) {
  ...
  this.getMappedCategory = function(categoryId) {
	  ...
	  return serviceCall('GET', 'category/getmappedcategory', inputParams);
  };
  ...
  this.getCategoriesCountBySeller = function(sellerId) {
	  ...
	  return serviceCall('GET', 'category/getcategroiescount', inputParams);
  };
  ...
  this.mapCategory = function(advatiserCategoryId, category) {
	  var inputParams = {
			  advatiserCategoryId, advatiserCategoryId,
			  category, category
			  };
	  return serviceCall('POST', 'category/mapsinglecategory', inputParams);
  } 
  ...
  this.getDepartment = function(pageNumber) {
	  ...
	  return serviceCall('GET', 'essentials/get/department', inputParams);
  };
  
  this.getEssentialCategories = function(essentialsDepartmentId, pageNumber) {
	  var inputParams = {
		essentialsDepartmentId: essentialsDepartmentId,
		pageNumber: pageNumber
	  };
	  
	  return serviceCall('GET', 'essentials/get/categories', inputParams);
  };
  
  this.deleteEssentialCategories = function(essentialCategoryId) {
	  var inputParams = {
		essentialCategoryId: essentialCategoryId
	  };
	  
	  return serviceCall('POST', 'essentials/delete/categories', inputParams);
  };
  ...
  this.createEssentialCategories = function(userId, medias, width, height, bcName, bcType, departmentId, categoryIds) {
	  ...
	  return serviceCall('POST', 'media/updateessentialcategory', inputParams);
  };
  ...
  this.createEssentialBanner = function(userId, medias, width, height, bcName, bcType, ctaUrl) {
	  ...
	  return serviceCall('POST', 'media/updateessentialbanner', inputParams);
  };
  ...
  this.getBanner = function(pageNumber) {
	  ...
	  return serviceCall('GET', 'essentials/get/banners', inputParams);
  };
  ...
  this.deleteBanner = function(bannerId) {
	  ...
	  return serviceCall('POST', 'essentials/delete/banners', inputParams);
  };
