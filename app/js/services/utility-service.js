...
.service('EssentialService', ['apiRepository', function(apiRepository) {
	
	this.getDepartment = function(pageNumber) {
		return apiRepository.getDepartment(pageNumber);
	};
	
	this.getEssentialCategories = function(essentialsDepartmentId, pageNumber) {
		return apiRepository.getEssentialCategories(essentialsDepartmentId, pageNumber);
	};
	
	this.deleteEssentialCategories = function(essentialCategoryId) {
		return apiRepository.deleteEssentialCategories(essentialCategoryId);
	};
	
	this.createEssentialCategories = function(userId, medias, width, height, bcName, bcType, departmentId, categoryIds) {
		return apiRepository.createEssentialCategories(userId, medias[0], width[0], height[0], bcName, bcType, departmentId, categoryIds);
	};
}])
.service('BannerService', ['apiRepository', function(apiRepository) {
	
	this.createEssentialBanner = function(userId, medias, width, height, bcName, bcType, ctaUrl) {
		return apiRepository.createEssentialBanner(userId, medias, width, height, bcName, bcType, ctaUrl);
	};
	
	this.getBanner = function(pageNumber) {
		return apiRepository.getBanner(pageNumber);
	};
	
	this.deleteBanner = function(bannerId) {
		return apiRepository.deleteBanner(bannerId);
	};
}])
...
.service('CmsService', ['apiRepository', function(apiRepository) {
	...
	this.getMappedCategory = function(categoryId){
		return apiRepository.getMappedCategory(categoryId);
	}
	
	this.getCategoriesCountBySeller = function(sellerId) {
		return apiRepository.getCategoriesCountBySeller(sellerId);
	}
	...
	this.mapCategory = function(advatiserCategoryId, category){
		return apiRepository.mapCategory(advatiserCategoryId, category);
	};
